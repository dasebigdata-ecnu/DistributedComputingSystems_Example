...
public class CustomerTrigger<W extends Window> extends Trigger<Object, W> {
  ...
  private final ReducingStateDescriptor<Long> processTimerStateDescriptor =
      new ReducingStateDescriptor<Long>(
          "processTimer", new CustomerTrigger.Update(), LongSerializer.INSTANCE);

  // |基于处理时间触发间隔|
  Long interval = 60L;

  public CustomerTrigger(long interval) {
